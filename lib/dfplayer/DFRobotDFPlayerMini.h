...
class DFRobotDFPlayerMini
{
  ...
  uint64_t _timeOutTimer;
  uint64_t _timeOutDuration = 500000; // 500ms
...
public:
  ...
  bool begin(uart_inst_t *uart, bool isACK = true, bool doReset = true);

  bool waitAvailable(uint64_t duration = 0);
  ...
  void setTimeOut(uint64_t timeOutDuration);
