...
bool DateTime::isValid() const
{
    ...
    uint8_t maxDays = daysInMonth[m - 1];
    if (m == 2 && yOff % 4 == 0)
        maxDays = 29;
...
/*!
    ...
    @return A pointer to the provided buffer. This is returned for
        convenience (e.g. for chaining or direct use in printing functions).
*/
/**************************************************************************/
...
*/
/**************************************************************************/
char *DateTime::timestamp(char *buffer, timestampOpt opt) const
{
